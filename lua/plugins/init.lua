...
return require('packer').startup(function(use)
    ...
    use {
        ...
        requires = {
            ...
            {'L3MON4D3/LuaSnip'}, {'rafamadriz/friendly-snippets'}, -- Null-ls
    ...
    use {
        ...
        requires = {
            {'rcarriga/nvim-dap-ui'}, {'jbyuki/one-small-step-for-vimkind'},
            {'mxsdev/nvim-dap-vscode-js'}, {'leoluz/nvim-dap-go'},
    ...
    use {
        ...
        config = function() require('colorschemes.tokyonight') end
    }
    ...
    use {
        ...
        config = function() require('colorschemes.solarized') end
    }
    ...
    use {
        ...
        tag = '*',
        config = function() require('plugins.toggleterm-nvim') end
    }
